<html>
<! ================================================================>
<!   Program Name: UploadItemDescription.php                       >
<!   Date:         2013-07-25                                      >
...
<!   ALERTS:                                                       >
<!                                                                 >
<!   This depends on the web_lob_clob_from_file procedure in       >
<!   the PLSQL schema. You can run it with the following file:     >
<!                                                                 >
<!   create_web_clob_loading.sql                                   >
<head>
<title>
  Chapter 8 : UploadItemDescription.php
</title>
<style>
