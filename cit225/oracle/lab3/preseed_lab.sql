...
,        status
FROM     user_constraints
WHERE    table_name = UPPER('COMMON_lookup_lab')
ORDER BY CASE
           WHEN constraint_type = 'PRIMARY KEY' THEN 1
           WHEN constraint_type = 'NOT NULL'    THEN 2
           WHEN constraint_type = 'CHECK'       THEN 3
...
, last_update_date )
 VALUES
( 1                           -- common_lookup_id
,UPPER('system_user_lab')                -- common_lookup_context
...
,UPPER('CONTACT_lab')                    -- common_lookup_context
...
,UPPER('MEMBER_lab')                     -- common_lookup_context
,'INDIVIDUAL'                 -- common_lookup_type
...
--   SYSTEM_USER_TYPE in the COMMON_lookup_lab table.
--  --------------------------------------------------
