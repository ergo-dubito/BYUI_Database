...
--  
-- ------------------------------------------------------------------
-- This creates the telephone_lab table and telephone_lab_s1 sequences.
-- ------------------------------------------------------------------
...
, CONSTRAINT fk_telephone_lab_1   FOREIGN KEY(contact_id) REFERENCES contact_lab(contact_id)
, CONSTRAINT fk_telephone_lab_2   FOREIGN KEY(telephone_type) REFERENCES common_lookup_lab(common_lookup_id)
, CONSTRAINT fk_telephone_lab_3   FOREIGN KEY(created_by) REFERENCES system_user_lab(system_user_id)
, CONSTRAINT fk_telephone_lab_4   FOREIGN KEY(last_updated_by) REFERENCES system_user_lab(system_user_id));
