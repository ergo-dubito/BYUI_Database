...
--  
-- ------------------------------------------------------------------
-- This creates the common_lookup_lab table and common_lookup_lab_s1 sequences.
-- ------------------------------------------------------------------
...
, CONSTRAINT pk_clookup_lab_1    PRIMARY KEY(common_lookup_id)
, CONSTRAINT fk_clookup_lab_1    FOREIGN KEY(created_by) REFERENCES system_user_lab(system_user_id)
, CONSTRAINT fk_clookup_lab_2    FOREIGN KEY(last_updated_by) REFERENCES system_user_lab(system_user_id));
...
-- Add a constraint to the SYSTEM_USER table dependent on the COMMON_LOOKUP_lab table.
