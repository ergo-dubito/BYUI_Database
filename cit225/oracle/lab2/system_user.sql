...
--  
-- ------------------------------------------------------------------
-- This creates the system_user_lab table and system_user_lab_s1 sequences.
-- ------------------------------------------------------------------
...
, CONSTRAINT fk_system_user_lab_1 FOREIGN KEY(created_by) REFERENCES system_user_lab(system_user_id)
, CONSTRAINT fk_system_user_lab_2 FOREIGN KEY(last_updated_by) REFERENCES system_user_lab(system_user_id));
